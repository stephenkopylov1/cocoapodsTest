...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of cocoapodsTest in Markdown format.
  ...
  s.homepage     = "https://github.com/stephenkopylov/cocoapodsTest"
  ...
  s.source       = { :git => "https://github.com/stephenkopylov/cocoapodsTest.git", :tag => "0.0.1" }
